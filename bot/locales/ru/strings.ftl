...
intro =
    Привет! 👋
    Я — помощник службы поддержки FlowerVPN. Через меня ты можешь обратиться в нашу техническую поддержку и получить помощь по любым вопросам.

help =
    Просто напиши свой вопрос в этом чате <3
